...
The complete reproducibility package for this study is publicly archived under DOI 10.5281/zenodo.22647942 \cite{HydrogenScreeningZenodo}. The GitHub repository, available at \url{https://github.com/williamjay1/hydrogen-corridor-screening}, provides version control, source code, issue traceability, and release records. Zenodo preserves the exact release snapshot and provides the persistent DOI used for citation. The DOI record corresponds to release v1.0.1 and contains the manuscript source, figures, model code, processed data products, tests, and provenance records. Later GitHub documentation updates do not change the contents identified by this DOI.
...
\bibitem{HydrogenScreeningZenodo}
J. Zhang, "Public-data hydrogen corridor screening," Zenodo, version 1.0.1, 2026, doi: 10.5281/zenodo.22647942. [Online]. Available: \url{https://doi.org/10.5281/zenodo.22647942}
